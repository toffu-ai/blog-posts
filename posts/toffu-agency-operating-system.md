...
> Move the disclaimer skill to the company tier - only Acme Bank gets the financial-services version.
...
1. The reporting format every client deck should follow
2. The QA checklist that runs before any campaign goes live
3. The pacing rule that flags accounts that are off track
