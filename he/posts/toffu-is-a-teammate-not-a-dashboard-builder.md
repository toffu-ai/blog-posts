...
שלב 2 הוא המקום שבו חי הממשק. תפריטים נפתחים, בוררי תאריכים, פילטרים, מתגים. לא כי היה משהו ערכי בהסתכלות על טבלאות מסוננות, אלא כי *האדם היה צוואר הבקבוק*. לאדם לא הייתה דרך אחרת לסרוק את מרחב החיתוכים האפשריים. הדשבורד היה תשתית עזר שנבנתה סביב המגבלות הקוגניטיביות של בני אדם.
...
מה שאומר שהתשתית הזו כבר לא נושאת משקל.
...
המודל המנטלי שפותח את השינוי הזה פשוט: *הפסיקו לחשוב כמו אנליסט, התחילו לחשוב כמו האדם שהאנליסט מדווח אליו.*

מנהל עסוק לא פותח דשבורד. מנהל עסוק קורא חמש נקודות, מקבל החלטה, וממשיך הלאה:

- ה-CAC ב-Meta עלה ב-34% משבוע לשבוע, בעקבות שחיקת קריאייטיב בחשבון B.
...
- שני חשבונות פועלים בקצב נמוך מהתקציב ויפספסו את יעדי סוף החודש.
...
3. להקליק על פילטרים בחיפוש אחר משהו.
...
שלבים 2, 3, ו-4 של הדרך הישנה מתאחדים לשלב אחד ש-Toffu מטפל בו על פני יותר נתונים ממה שהייתם יכולים לכסות בהקלקות.
...
- *דשבורד הוא משטח שחוקרים.* המטרה שלו היא לאפשר לכם לנווט במרחב לא ידוע. הוא מוגדר על ידי הבקרות שלו: פילטרים, תפריטים נפתחים, טאבים, בוררי תאריכים. הערך חי באינטראקציה. הסירו את הבקרות ואין לו מה להגיד.
...
מבחן פשוט: הסירו כל בקרה אינטראקטיבית מהתוצר. אם מה שנשאר עדיין אומר לכם משהו שימושי, זה היה דוח. אם מה שנשאר זו מסגרת ריקה של פילטרים, זה היה דשבורד.
...
כשאתם מבקשים מ-Toffu תוצר, נטו לכיוון דוח. שאלו את השאלה. תנו ל-Toffu לענות עליה במקום, עם גרפים וטקסט. אם אתם תופסים את עצמכם מתארים תפריטים נפתחים וטאבים, גלשתם חזרה לחשיבת דשבורד.
